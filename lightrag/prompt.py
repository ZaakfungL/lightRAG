...
Your goal is to populate a structured JSON object that accurately answers the user's query. The answer MUST be generated by integrating relevant facts from the Document Chunks found in the **Context**.
...
Before answering, you MUST map document file names to their corresponding reference IDs using this mapping table:

```python
document_id_mapping = {
    "2023-amazon-sustainability-report.md": "amazon2023",
    "2405.01814.md": "chen2024",
    "2505.06371.md": "chung2025",
    "2405.21015.md": "cottier2024",
    "2206.05229.md": "dodge2022",
    "2410.06681.md": "ebert2024",
    "2306.03163.md": "erben2023",
    "2504.17674.md": "fernandez2025",
    "2404.14527.md": "griggs2024",
    "2412.06288.md": "han2024",
    "2505.09598.md": "jegham2025",
    "2504.06307.md": "khan2025",
    "2504.11816.md": "kim2025",
    "2309.03852.md": "li2025a",
    "2304.03271.md": "li2025b",
    "2302.08476.md": "luccioni2023",
    "2311.16863.md": "luccioni2024",
    "2501.16548.md": "luccioni2025a",
    "2504.00797.md": "luccioni2025b",
    "2506.15572.md": "luccioni2025c",
    "2503.05804.md": "morrison2025",
    "2104.10350.md": "patterson2021",
    "2501.05899.md": "rubei2025",
    "2310.03003.md": "samsi2024",
    "1907.10597.md": "schwartz2019",
    "2404.07413.md": "shen2024",
    "2211.06318.md": "stone2022",
    "1906.02243.md": "strubell2019",
    "2111.00364.md": "wu2021a",
    "2108.06738.md": "wu2021b",
    "2408.04693.md": "xia2024",
    "2508.14170.md": "zschache2025"
}
```
...
6. ref_id:
  ...
  - For single document: ["amazon2023"]
  - For multiple documents: ["wu2021b","patterson2021"]
  - Always format as a JSON array, even for single documents.
...
3. Unanswerable Questions: If you cannot answer with confidence based on the provided documents, you MUST use "is_blank" for answer_value, answer_unit, ref_id, ref_url, supporting_materials, and explanation. The answer field should state: "Unable to answer with confidence based on the provided documents."
4. Precision: For numeric answers, be precise and include the exact number from the source.
5. Categorical: For categorical answers (TRUE/FALSE/YES/NO), use exact uppercase values.
6. Conversation History: Consider the conversation history (if provided) to understand the user's intent, but base the answer only on the current **Context**.
